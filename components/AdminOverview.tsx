    ...
    <div className="space-y-4 sm:space-y-5 md:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
        <div
          ...
          onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); router.push('/admin/bookings'); } }}
          className="cursor-pointer hover:shadow-lg active:scale-[0.98] transition-all"
        >
          <Card className="border-2 border-[var(--border)] min-h-[80px] sm:min-h-[100px] flex items-center">
        ...
        <div
          ...
          onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); router.push('/admin/users'); } }}
          className="cursor-pointer hover:shadow-lg active:scale-[0.98] transition-all"
        >
          <Card className="border-2 border-[var(--border)] min-h-[80px] sm:min-h-[100px] flex items-center">
            <CardContent className="p-3 sm:p-4 w-full">
        ...
        <div
          ...
          onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); router.push('/admin/grounds/new'); } }}
          className="cursor-pointer hover:shadow-lg active:scale-[0.98] transition-all"
        >
          <Card className="border-2 border-[var(--border)] min-h-[80px] sm:min-h-[100px] flex items-center">
            <CardContent className="p-3 sm:p-4 w-full">
