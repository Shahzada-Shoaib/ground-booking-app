      ...
      <div className="relative px-4 py-6 sm:px-6 sm:py-8 lg:px-12 lg:py-12">
        ...
        <div className="flex items-start justify-between mb-4 sm:mb-6">
          ...
          <div className="ml-2 sm:ml-4 flex-shrink-0">
            <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-[var(--primary-500)] rounded-full flex items-center justify-center shadow-lg dark:bg-white">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-white dark:text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
